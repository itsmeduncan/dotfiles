...
- **AI:** opencode (CLI agent), ollama (local LLMs)
...
- **GUI apps (casks):** Ghostty, OrbStack, 1Password, Slack, Notion, Obsidian, Tailscale, Ollama, gcloud-cli
